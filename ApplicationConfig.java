...
@Configuration
    ...
    public class ApplicationConfig {
        ...
        public LocalSessionFactoryBean sessionFactory() {
            ...
            sessionFactory.setPackagesToScan("com.aoshine.demo.entity.response.db");
        ...
        public DataSource dataSource() {
            String RDS_ENDPOINT = "twitchproject.c8cdnwwnanfi.us-east-1.rds.amazonaws.com";
            String USERNAME = "admin";
            String PASSWORD = "6419QWer";
